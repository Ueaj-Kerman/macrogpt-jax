...
LLAMA3_5B = llama3_model(5.20, vocab_size=128256)
LLAMA3_7B = llama3_model(6.00, vocab_size=128256)
...
if __name__ == "__main__":
	...
	print(f"LLAMA3-2B has {format_param_count(count_parameters(LLAMA3_2B))} parameters")
	print(f"LLAMA3-3B has {format_param_count(count_parameters(LLAMA3_3B))} parameters")
	print(f"LLAMA3-5B has {format_param_count(count_parameters(LLAMA3_5B))} parameters")
